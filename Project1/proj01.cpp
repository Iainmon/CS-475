...
#ifdef CSV
        fprintf(stderr, "%2d, %8d, %6.2f, %6.2f\n", NUMT, NUMTRIALS, 100.*probability, maxPerformance );

        double end_time = omp_get_wtime( );
        fprintf(stdout, "%2d threads : %8d trials ; probability = %6.2f ; megatrials/sec = %6.2lf; total_time = %6.6f\n",
                NUMT, NUMTRIALS, 100.*probability, maxPerformance, end_time - start_time);
#else   
